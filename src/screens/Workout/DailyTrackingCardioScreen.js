...
const localWeeklyRoutine = [
  {
    day: "Monday",
    focus: "Chest & Triceps + HIIT",
    cardio: "20 Mins Sprints",
    precaution: "Keep elbows tucked to protect shoulder joints.",
    dietPlan: {
      breakfast: ["Brown Bread", "Peanut Butter", "Milk"],
      lunch: ["Chicken Wrap", "Fresh Juice"],
      snacks: ["Nuts", "Fruit Salad"],
      dinner: ["Grilled Fish", "Vegetables"],
      beforeSleep: ["Green Tea"]
    },
    exercises: [
      { id: "m1", name: "Bench Press", details: "4 Sets x 12 Reps", image: require('../../../assets/images/monday1.jpg') },
      { id: "m2", name: "Flat Dumbbell Flyes", details: "4 Sets x 12 Reps", image: require('../../../assets/images/monday2.jpg') },
      { id: "m3", name: "Tricep Overhead Pushdowns", details: "4 Sets x 15 Reps", image: require('../../../assets/images/monday3.jpg') },
      { id: "m4", name: "Rope Skull Crushers", details: "3 Sets x 12 Reps", image: require('../../../assets/images/monday4.jpg') }
    ]
  },
  {
    day: "Tuesday",
    ...
    precaution: "Do not ego lift; maintain a straight spine.",
    dietPlan: {
      breakfast: ["Oatmeal", "Banana", "3 Egg Whites"],
      lunch: ["Brown Rice", "Grilled Chicken Breast", "Salad"],
      snacks: ["Protein Shake", "Almonds"],
      dinner: ["Baked Salmon", "Broccoli", "Sweet Potato"],
      beforeSleep: ["Warm Milk / Casein"]
    },
    exercises: [
      { id: "tu1", name: "Lat Pulldowns", details: "4 Sets x 12 Reps", image: require('../../../assets/images/tuesday1.jpg') },
      { id: "tu2", name: "Dead Lift", details: "4 Sets x 12 Reps", image: require('../../../assets/images/tuesday2.jpg') },
      { id: "tu3", name: "Barbell Bicep Curls", details: "4 Sets x 15 Reps", image: require('../../../assets/images/tuesday3.jpg') },
      { id: "tu4", name: "Incline Dumbbell Curls", details: "3 Sets x 12 Reps", image: require('../../../assets/images/tuesday4.jpg') }
    ]
  },
  {
    day: "Wednesday",
    focus: "Leg Day (Quads) + Low Intensity",
    cardio: "15 Mins Cycle",
    precaution: "Ensure knees do not cave inward during squats.",
    dietPlan: {
      breakfast: ["Muesli", "Greek Yogurt", "Chia Seeds"],
      lunch: ["Tuna Salad Sandwich", "Orange Juice"],
      snacks: ["Mixed Berries", "Walnuts"],
      dinner: ["Lean Beef Stir-fry", "Quinoa", "Asparagus"],
      beforeSleep: ["Chamomile Tea"]
    },
    exercises: [
      { id: "w1", name: "Barbell Squats", details: "5 Sets x 10 Reps", image: require('../../../assets/images/wednesday1.jpg') },
      { id: "w2", name: "Leg Press Matrix", details: "4 Sets x 12 Reps", image: require('../../../assets/images/wednesday2.jpg') },
      { id: "w3", name: "Leg Extensions", details: "4 Sets x 15 Reps", image: require('../../../assets/images/wednesday3.jpg') },
      { id: "w4", name: "Standing Calf Raises", details: "4 Sets x 20 Reps", image: require('../../../assets/images/wednesday4.jpg') }
    ]
  },
  {
    day: "Thursday",
    focus: "Shoulders Hypertrophy & Abs Core",
    cardio: "20 Mins High Knee Row",
    precaution: "Keep core tight on press matrix to safeguard spine.",
    dietPlan: {
      breakfast: ["Scrambled Eggs", "Whole Wheat Toast", "Apple"],
      lunch: ["Chicken Caesar Salad", "Pomegranate Juice"],
      snacks: ["Roasted Chickpeas", "Green Tea"],
      dinner: ["Baked Chicken Legs", "Mixed Sauteed Veggies"],
      beforeSleep: ["Almond Milk"]
    },
    exercises: [
      { id: "th1", name: "Overhead Dumbbell Press", details: "4 Sets x 12 Reps", image: require('../../../assets/images/thursday1.jpg') },
      { id: "th2", name: "Dumbbell Raise Matrix", details: "4 Sets x 15 Reps", image: require('../../../assets/images/thursday2.jpg') },
      { id: "th3", name: "Front Raise Matrix", details: "3 Sets x 12 Reps", image: require('../../../assets/images/thursday3.jpg') },
      { id: "th4", name: "Leg Raise Matrix", details: "4 Sets x 20 Reps", image: require('../../../assets/images/thursday4.jpg') }
    ]
  },
  {
    day: "Friday",
    focus: "Arms Isolation Blitz (Biceps & Triceps)",
    cardio: "25 Mins Cross Trainer Stair",
    precaution: "Focus fully on mind-muscle squeeze, control negative reps.",
    dietPlan: {
      breakfast: ["Boiled Eggs", "Protein Oatmeal", "Berries"],
      lunch: ["Turkey Wrap", "Avocado Shake"],
      snacks: ["Peanut Butter with Apple Slices"],
      dinner: ["Grilled Beef Steak", "Mashed Potatoes", "Beans"],
      beforeSleep: ["Boiled Egg Whites"]
    },
    exercises: [
      { id: "f1", name: "Preacher Curls Blast", details: "4 Sets x 12 Reps", image: require('../../../assets/images/friday1.jpg') },
      { id: "f2", name: "Triceps Cable Pushdowns", details: "4 Sets x 15 Reps", image: require('../../../assets/images/friday2.jpg') },
      { id: "f3", name: "Hammer Curls Protocol", details: "3 Sets x 12 Reps", image: require('../../../assets/images/friday3.jpg') },
      { id: "f4", name: "Diamond Push-Ups Max", details: "3 Sets to Failure", image: require('../../../assets/images/friday4.jpg') }
    ]
  },
  {
    day: "Saturday",
    ...
    precaution: "Drive power explicitly through your heels.",
    dietPlan: {
      breakfast: ["Pancake Oatmeal Mix", "Honey", "Milk"],
      lunch: ["Brown Rice Bowl", "Fish Curry", "Cucumber Salad"],
      snacks: ["Mixed Dry Fruits", "Black Coffee"],
      dinner: ["Barbecue Chicken", "Baked Asparagus Grid"],
      beforeSleep: ["Herbal Relax Blend Tea"]
    },
    exercises: [
      { id: "s1", name: "Romanian Deadlifts", details: "4 Sets x 10 Reps", image: require('../../../assets/images/saturday1.jpg') },
      { id: "s2", name: "Walking Lunges Matrix", details: "3 Sets x 15 Reps Each", image: require('../../../assets/images/saturday2.jpg') },
      { id: "s3", name: "Seated Hamstring Curls", details: "4 Sets x 12 Reps", image: require('../../../assets/images/saturday3.jpg') },
      { id: "s4", name: "Heavy Calf Press Node", details: "4 Sets x 25 Reps", image: require('../../../assets/images/saturday4.jpg') }
    ]
  }
];

export default function DailyTrackingScreen({ navigation }) {
          ...
          <View style={[styles.widgetActive, { width: '98%', maxWidth: 1100, height: '97%', padding: 24, position: 'relative' }]}>
            ...
            <ScrollView ref={modalScrollRef} showsVerticalScrollIndicator={false} style={{ width: '100%', marginBottom: 10 }}>
              ...
              <View style={{ borderTopWidth: 1, borderColor: currentTheme.border, paddingTop: 15 }}>
                ...
                <View style={{ flexDirection: 'row', justifyInjected: 'space-between', marginBottom: 10 }}>
                  <TouchableOpacity 
        ...
        <View style={[styles.widgetActive, { marginTop: 20, padding: 25 }]}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 15 }}>
            <View style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.02)', padding: 12, borderRadius: 10, alignItems: 'center', marginRight: 5, borderWidth: 1, borderColor: currentTheme.border }}>
              <Text style={{ color: currentTheme.textGray, fontSize: 10, textAlign: 'center' }}>PROJECTED LOSS</Text>
          ...
          <Text style={{ color: currentTheme.textGray, fontSize: 13, marginTop: 15, fontStyle: 'italic', textAlign: 'center', lineHeight: 18 }}>
            {parseFloat(calculateProgressDelta()) > 0 && estimates.overallAdherence === "0" 
              ? "⚠️ Warning: Actual loss registered without logging routine adherence. Please audit workout metrics for authentic calibration."
              : "✓ Analysis Complete: Reality metrics successfully compared against system tracking profiles."}
          </Text>
